...
SELECT id_pedido, situacao,IFNULL( situacao, 'Cancelado') FROM pedidos*//*SELECT nome,cargo,salario,  IF(salario > 3000, 'acima da media', 'abaixo da media')AS media_salario FROM funcionarios*/
